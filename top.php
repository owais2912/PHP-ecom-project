...
$page_title='Ecom Website';
if($my_page=='product.php'){
$product_id=get_safe_value($con,$_GET['id']);
$product_meta= mysqli_fetch_assoc(mysqli_query($con,"select * from product where id='$product_id'"));
$page_title =$product_meta['name'];
$meta_desc=$product_meta['short_desc'];
}

if($my_page=='index.php'){
	$page_title ='Home';
}
if($my_page=='categories.php'){
	$category_id=get_safe_value($con,$_GET['id']);
	$product_meta= mysqli_fetch_assoc(mysqli_query($con,"select * from categories where id='$category_id'"));
	$page_title =$product_meta['categories'];
}
...
if($my_page=='my_order_details.php'){
	$page_title ='My Order details';
}
if($my_page=='profile.php'){
	$page_title ='My Profile';
}
if($my_page=='wishlist.php'){
	$page_title ='Wishlist';
}
